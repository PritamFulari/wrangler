...
import io.cdap.wrangler.statistics.AggregateStats;
  ...
  public SystemDirectiveRegistry(List<String> namespaces) throws DirectiveLoadException {
    ...
    for (String namespace : namespaces) {
      try {
        ...
        // MANUAL REGISTRATION: Add AggregateStats directive explicitly
        DirectiveInfo aggregateStatsInfo = DirectiveInfo.fromSystem(AggregateStats.class);
        registry.put(aggregateStatsInfo.name(), aggregateStatsInfo);
